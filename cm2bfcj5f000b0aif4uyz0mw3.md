...
datePublished: Wed Oct 16 2024 05:21:21 GMT+0000 (Coordinated Universal Time)
cuid: cm2bfcj5f000b0aif4uyz0mw3
slug: developing-rapidly-with-generative-ai
canonical: https://memo.d.foundation/playground/ai/developing-rapidly-with-generative-ai.md
cover: https://memo.d.foundation/playground/ai/assets/developing-rapidly-with-generative-ai_ai-eco.webp
tags: ai, tooling, llm
...
![](https://memo.d.foundation/playground/ai/assets/developing-rapidly-with-generative-ai_llm-building-stages.webp)
...
![](https://memo.d.foundation/playground/ai/assets/developing-rapidly-with-generative-ai_evaluating-prompts.webp)

### 4. Deploying at Scale

![A high-level architecture for an LLM application](https://memo.d.foundation/playground/ai/assets/developing-rapidly-with-generative-ai_llm-arch.webp) This involves setting up the infrastructure to handle the expected load, monitoring the system's performance, and ensuring that the feature continues to meet the requirements set in the previous stages. There are 2 ways to consider for deploying:
