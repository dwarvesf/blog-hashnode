...
cuid: cm2bfcdcf000509jsf6y44ol8
slug: multimodal-in-rag
canonical: https://memo.d.foundation/playground/ai/building-llm-system/multimodal-in-rag.md
cover: https://memo.d.foundation/playground/ai/building-llm-system/assets/multimodal-in-rag-multimodel-llm.webp
tags: llm, vector-database, rag
...
![](https://memo.d.foundation/playground/ai/building-llm-system/assets/multimodal-in-rag-multimodel-llm.webp)
...
![](https://memo.d.foundation/playground/ai/building-llm-system/assets/multimodal-in-rag-img-summary.webp)
...
3. **Testing**: To testing what we have done so far, let take and image in document and findout our RAG can extract the information from it and answer correctly.
   ...
   ![](https://memo.d.foundation/playground/ai/building-llm-system/assets/multimodal-in-rag-testing.webp)
